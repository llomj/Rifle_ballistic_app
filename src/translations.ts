export const translations = {
  en: {
    ...
    ballistic: {
      ...
      rifleProfilesComingSoon: "User profiles coming soon.",
      ...
      table150to800: "150–1200 m table",
      ...
      zeroAtZoomMag: "Zero at {distance} m, zoom at {mag}×.",
      zeroAtYdZoomMag: "Zero at {distance} yd, zoom at {mag}×.",
      zeroAtZoomAnyMag: "Zero at {distance} m, any magnification (FFP).",
      zeroAtYdZoomAnyMag: "Zero at {distance} yd, any magnification (FFP).",
      formulaHeightMils: "Formula: height × 1000 / mils = distance",
      formulaHeightMoa: "Formula: height × 3438 / MOA ≈ distance (m) (true MOA)",
      ...
      ammunitionForCaliber: "Ammunition for",
      noBulletsForCaliber: "No ammunition entries for this caliber.",
      selectRifleFirst: "Select a rifle above to see compatible ammunition.",
      averageSpeed: "Average speed",
      trajectorySpeed: "Trajectory MV",
      shotInclination: "Inclination (°)",
      shotInclinationHint: "+ uphill · − downhill · 0 flat",
      powderTemp: "Powder temp (°C)",
      mvRefTemp: "MV ref. temp (°C)",
      windSpeed: "Wind speed",
      windFromClock: "Wind from (° clock)",
      windClockHint: "12 = headwind · 90 = 3 o'clock (your right) · default 90 if blank",
      windCorrectionLine: "Wind: {drift} drift · {angle} {unit} · ^{clicks} wind {hold}",
      windCorrectionShort: "Wind ^{clicks} {hold}",
      windHoldRight: "hold R",
      windHoldLeft: "hold L",
      windDriftHelp: "Drift = crosswind × time of flight (same BC/MV as drop). Windage clicks match your scope.",
      windDriftInApp: "App wind drift (your profile)",
      windDriftInAppDesc:
        "Set wind speed and clock under Hub → Rifle profile. Correction uses your scope’s MIL/MOA and windage click value. It appears on the main circle when you enter distance, and on Distance / Height results.",
      windReferenceSamples: "Samples along your turret table range (needs trajectory + wind speed):",
      windReferenceRow: "{drift} · {angle} {unit} · ^{clicks} {hold}",
      windReferenceSetSpeed: "Add wind speed in your profile to see sample drift lines here.",
      recoil: "Recoil",
      ...
      panelOptics: "Optics",
      opticsPanelTitleMag: "Optics ({mag}×)",
      opticsPanelTitleFfp: "Optics (FFP)",
      opticsReferenceAtMag: "{mag}× reference",
      opticsReferenceFfp: "Any magnification (FFP)",
      opticsSelectScopeNote: "Select a scope in Rifle & scope above to see magnification.",
      panelWind: "Wind",
      ...
      compHeaderDrop: "drop",
      compProfileNote: "From your user profile: the table shows bullet drop (cm or in) and the holdover in mrad or MOA at each distance. Use your scope turret to dial the given value, or use your reticle to hold that amount above the aim point.",
    ...
    firstPage: {
      ...
      inclinToggle: "Slope angle (phone clinometer)",
      inclinCalibrate: "Level",
      inclinApply: "Apply",
      inclinClear: "Clear",
      inclinLive: "Slope",
      inclinProfile: "Profile",
      inclinRollWarn: "Reduce roll — hold phone vertical",
      inclinNoSensor: "Orientation not available on this device",
      inclinNeedCalibrate: "Tap Level while aiming flat, then point at target",
      infoTitle: "Main page — elevation clicks",
      infoText: "Enter distance (m or yd). The ^clicks value shows how many elevation turret clicks you need to dial to hit the target at that range. Uses your user profile (Profile → Targets zero distance) and ballistic data. Optional: enable the slope icon, calibrate while aiming level, point the phone at the target, then Apply — same as Inclination (°) in your profile.",
  ...
  fr: {
    ...
    ballistic: {
      ...
      distance: "Distance",
      rifleProfile: "Profil utilisateur",
      ...
      rifleProfilesComingSoon: "Profils utilisateur bientôt disponibles.",
      ...
      table150to800: "tableau 150–1200 m",
      ...
      zeroAtZoomMag: "Zéro à {distance} m, zoom à {mag}×.",
      zeroAtYdZoomMag: "Zéro à {distance} yd, zoom à {mag}×.",
      zeroAtZoomAnyMag: "Zéro à {distance} m, toute magnification (FFP).",
      zeroAtYdZoomAnyMag: "Zéro à {distance} yd, toute magnification (FFP).",
      formulaHeightMils: "Formule: hauteur × 1000 / mils = distance",
      formulaHeightMoa: "Formule : hauteur × 3438 / MOA ≈ distance (m) (MOA vrai)",
      ...
      ammunitionForCaliber: "Munition pour",
      noBulletsForCaliber: "Aucune munition pour ce calibre.",
      selectRifleFirst: "Choisissez un fusil ci-dessus pour afficher les munitions compatibles.",
      averageSpeed: "Vitesse moyenne",
      trajectorySpeed: "Vitesse balistique",
      shotInclination: "Inclinaison (°)",
      shotInclinationHint: "+ montée · − descente · 0 plat",
      powderTemp: "Temp. poudre (°C)",
      mvRefTemp: "T réf. V init. (°C)",
      windSpeed: "Vitesse du vent",
      windFromClock: "Vent depuis (° horloge)",
      windClockHint: "12 = face · 90 = 3 h (à droite) · défaut 90 si vide",
      windCorrectionLine: "Vent : {drift} · {angle} {unit} · ^{clicks} {hold}",
      windCorrectionShort: "Vent ^{clicks} {hold}",
      windHoldRight: "tenir D",
      windHoldLeft: "tenir G",
      windDriftHelp: "Dérive = vent de travers × temps de vol (même BC/V0 que la chute). Clics = valeur de clic de la lunette.",
      windDriftInApp: "Dérive vent dans l’app (votre profil)",
      windDriftInAppDesc:
        "Renseignez vitesse et horloge sous Hub → Profil carabine. La correction utilise les MIL/MOA et les clics de dérive de votre lunette. Affichée sur le cercle principal (distance saisie) et dans les résultats Distance / Hauteur.",
      windReferenceSamples: "Exemples sur la plage du tableau tourelles (trajectoire + vitesse vent requises) :",
      windReferenceRow: "{drift} · {angle} {unit} · ^{clicks} {hold}",
      windReferenceSetSpeed: "Ajoutez une vitesse de vent dans le profil pour voir des exemples de dérive ici.",
      recoil: "Recul",
      coefficient: "Coefficient",
      ...
      panelCompensation: "Compensation",
      panelOptics: "Optique",
      opticsPanelTitleMag: "Optique ({mag}×)",
      opticsPanelTitleFfp: "Optique (FFP)",
      opticsReferenceAtMag: "Référence {mag}×",
      opticsReferenceFfp: "Toute magnification (FFP)",
      opticsSelectScopeNote: "Choisissez une lunette dans Carabine & lunette ci-dessus pour voir la magnification.",
      panelWind: "Vent",
      ...
      compProfileNote: "D’après votre profil utilisateur : le tableau indique la chute du projectile (cm ou po) et la compensation en mrad ou MOA à chaque distance. Utilisez la tourelle de la lunette pour régler la valeur indiquée, ou le réticule pour maintenir cette valeur au-dessus du point de visée.",
    ...
    firstPage: {
      ...
      inclinToggle: "Angle de pente (clinomètre téléphone)",
      inclinCalibrate: "Niveau",
      inclinApply: "Appliquer",
      inclinClear: "Effacer",
      inclinLive: "Pente",
      inclinProfile: "Profil",
      inclinRollWarn: "Moins d'inclinaison latérale — tenez le téléphone vertical",
      inclinNoSensor: "Orientation indisponible sur cet appareil",
      inclinNeedCalibrate: "Niveau en visée horizontale, puis visez la cible",
      backToFirst: "Retour à la première page",
      infoTitle: "Page principale — clics d'élévation",
      infoText: "Entrez la distance (m ou yd). Le ^clics indique combien de clics de tourelle d'élévation régler pour toucher la cible à cette portée. Utilise votre profil utilisateur (Profil → Cibles, zéro) et les données balistiques. Option : activez l'icône pente, calibrez en visée horizontale, pointez le téléphone vers la cible, puis Appliquer — comme l'Inclinaison (°) du profil.",
